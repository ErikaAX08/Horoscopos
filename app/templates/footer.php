    ...
    <div class="menu_container">
        <div>
            ...
            <ul class="menu_list">
                ...
                <li class="text">Optimización SEO</li>
        ...
        <div>
            ...
            <ul class="menu_list">
                ...
                <li class="text">Testimonios</li>
                <li class="text">Contacto</li>
            </ul>
        </div>
        <div>
            ...
            <ul class="menu_list">
                ...
                <li class="text">Preguntas Frecuentes</li>
                <li class="text">Términos & Condiciones</li>
            </ul>
        </div>
    </div>
</footer>
